...
- [國際及兩岸定期航線班機載客率－按航線別分](https://www.caa.gov.tw/article.aspx?a=1752&lang=1)
...
- 本專案資料由公開 ODS 檔自行解析、整理與視覺化，可能因原始資料更新、解析規則、航點代碼映射、四捨五入、系統處理、更新時差或資料清理方式而與原始公告產生遺漏、延遲或差異。
- 正式數據、最新版本與資料定義，請以交通部民用航空局原始公告頁面與下載檔案為準。
- 本專案內容僅供資料探索、研究與視覺化展示，不構成投資建議、營運建議、交易建議、訂票建議或任何形式的決策保證。
- 使用者依據本專案內容所作之判斷、引用、投資、交易、營運或其他行動，其結果與風險由使用者自行判斷與承擔。

### 問題回報與合作洽詢

資料錯誤、功能建議或合作洽詢，請來信：<taiwanairlinedata@gmail.com>
